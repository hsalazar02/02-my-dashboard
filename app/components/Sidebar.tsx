...
export const Sidebar = () => {
  return (
    <div
      id="menu"
      className="bg-gray-900 min-h-screen text-slate-300 w-64 overflow-y-scroll"
    >
      <div id="logo" className="my-4 px-6">
        <h1 className="text-lg md:text-2xl font-bold text-white flex items-center">
          <IoLogoReact className="mr-2" />
          <span>Dash</span>
          <span className="text-blue-500 ml-1">8</span>.
        </h1>
      ...
      <div id="profile" className="px-6 py-10">
        ...
        <a href="#" className="inline-flex space-x-2 items-center">
          ...
          <span className="text-sm md:text-base font-bold">Heiner Salazar</span>
        </a>
      </div>
